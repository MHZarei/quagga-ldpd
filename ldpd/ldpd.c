...
#include "ldp_debug.h"
#ifdef HAVE_ZEROMQ
#include "ldp.capnp-gen.h"
#include "ldpd.ndef-gen.h"
#endif
...
main(int argc, char *argv[])
{
	...
	while (1) {
		...
		opt = getopt_long(argc, argv, "df:i:z:hA:P:u:g:vCLEZ:",
		    longopts, 0);
...
#ifdef HAVE_ZEROMQ
	QZC_NODE_REG(ldpd_conf, ldpd_conf)
#endif
